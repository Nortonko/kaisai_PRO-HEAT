...
- **climate entita**: režim (OFF / chladenie / kúrenie / sušenie / ventilátor / auto),
  cieľová teplota (16–31 °C), aktuálna teplota, swing (OFF/vert/horiz/both)
- **switch**: ECO, Sleep, Health, Anti-mildew
- **select**: ventilátor (8 stupňov: AUTO/MUTE/LOW/LOW-MID/MID/MID-HIGH/HIGH/TURBO)
  a poloha vertikálnej/horizontálnej lamely (kývanie, prúdové režimy, odstupňované polohy)

> Ventilátor je zámerne samostatná `select` entita (nie súčasť climate karty),
> aby si zachoval presné názvy stupňov a bol nezávislý od meniaceho sa
> ESPHome API pre „custom fan modes".
